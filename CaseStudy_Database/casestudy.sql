...
where  (year(now())-year(customer_birthday)) between 18 and 50 and customer_address = 'Đà Nẵng' or customer_address ='Quảng Trị';
...
from attachservices
 ...
 join customertypes using (customer_type_id) 
where customertypes.customer_type_name = 'Diamond' and customers.customer_address in ( 'vinh','Quảng Ngãi') and attach_service_id<>1;
